...
[horizontal]
*2.1requirement1*:: Filename must have ".nc" suffix.
...
[horizontal]
2.2requirement1*:: CF attributes that take string values must be 1D character arrays.
...
[horizontal]
*2.3requirement1*:: Variable, dimension and attribute names must begin with a letter and
be composed of letters, digits, and underscores.

*Recommendations:*

[horizontal]
*2.3recommendation1*:: No two variable names should be identical when case is ignored.
...
[horizontal]
*2.4requirement1*:: The dimensions of a variable must all have different names.

*Recommendations:*

[horizontal]
*2.4recommendation1*:: If any or all of the dimensions of a variable have the interpretations
