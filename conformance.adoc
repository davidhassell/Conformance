...
* *[2.1e1]* Filename must have ".nc" suffix.
...
* *[2.2e1]* CF attributes that take string values must be 1D character arrays.
...
* *[2.3e1]* Variable, dimension and attribute names must begin with a letter and
be composed of letters, digits, and underscores.

*Recommendations:*

* *[2.3w1]* No two variable names should be identical when case is ignored.
...
* *[2.4e1]* The dimensions of a variable must all have different names.

*Recommendations:*

[horizontal]
*2.4w1*:: If any or all of the dimensions of a variable have the interpretations
...
*2.4w2*:: In files that are meant to conform to the COARDS subset of CF, any
...
In::
2.5.1w1:: The value of the **`_FillValue`** attribute should not be within a specified
valid range.
2.5.1w2:: If both **`missing_value`** and **`_FillValue`** be used, they should have the
same value.
