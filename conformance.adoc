...
[horizontal]
*7.2.requirement.1*:: The type of the **`cell_measures`** attribute is a string whose value is
...
*7.2.requirement.2*::: A measure variable must have units that are consistent with the
